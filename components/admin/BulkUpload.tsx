...
export default function BulkUpload({ onClose }: BulkUploadProps) {
  ...
  const downloadTemplate = () => {
    const headers = ["name_en", "name_tr", "name_ru", "name_ar", "slug", "sku", "oem_code", "brand", "category_id", "stock_status", "stock_quantity", "min_order_qty", "qty_step", "description_en", "description_tr", "description_ru", "description_ar"];
    const sample = ["Bosch Injector", "Bosch Enjektör", "Форсунка Bosch", "حاقن بوش", "", "SKU001", "F00VC99002", "Bosch", "", "in_stock", "10", "1", "1", "Common rail injector", "Common rail enjektör", "Форсунка common rail", "حاقن كومون ريل"];
